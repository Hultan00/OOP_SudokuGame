            ...
            case 1:
                for (int row = 0; row < GRID_SIZE; row++) {
                    for (int col = 0; col < 5; col++) {
                        int val = matrix[row][(GRID_SIZE-col)-1][0];
                        matrix[row][(GRID_SIZE-col)-1][0] = matrix[row][col][0];
                        matrix[row][col][0] = val;
                    }
                }
                for (int row = 0; row < GRID_SIZE; row++) {
                    for (int col = 0; col < 5; col++) {
                        int val = matrix[row][(GRID_SIZE-col)-1][1];
                        matrix[row][(GRID_SIZE-col)-1][1] = matrix[row][col][1];
